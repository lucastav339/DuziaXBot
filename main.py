...
STATE: Dict[int, UserState] = {}  # Para produção multi-instância, use Redis/DB
...
async def on_startup(app):
    # Se NÃO for webhook, apaga webhook pra evitar conflito com polling
...
def run():
    ...
    if port and url:
        ...
        # POLLING (serviço Worker no Render)
        app.run_polling(
